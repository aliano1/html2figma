...
import { termsPage, privacyPage, securityPage } from './legal.mjs';
...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (accounts) {
      ...
      if (req.method === 'GET' && (u.pathname === '/terms' || u.pathname === '/privacy' || u.pathname === '/security')) return html(200, ({ '/terms': termsPage, '/privacy': privacyPage, '/security': securityPage })[u.pathname](), { 'cache-control': 'public, max-age=300' });
