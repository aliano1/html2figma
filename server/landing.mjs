...
<footer><span>© ${new Date().getFullYear()} ${esc(productName)}</span><span><a href="/account">Account</a> · <a href="#pricing">Pricing</a> · <a href="/terms">Terms</a> · <a href="/privacy">Privacy</a> · <a href="/security">Security</a>${supportEmail ? ` · <a href="mailto:${esc(supportEmail)}">Support</a>` : ''}</span></footer>
</div>
</body></html>`;
}
